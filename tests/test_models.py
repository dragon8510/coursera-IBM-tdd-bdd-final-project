...
class TestProductModel(unittest.TestCase):
    ...
    def test_deserialize_missing_data(self):
        ...
        data = {"id": 1, "name": "Kitty", "description": "Toy for cats"}
        product = Product()
    ...
    def test_deserialize_bad_available(self):
        ...
        data["available"] = "true"  # wrong type
        product = Product()
        self.assertRaises(DataValidationError, product.deserialize, data)

    def test_deserialize_bad_category(self):
        """It should not deserialize a Product with bad category data"""
        test_product = ProductFactory()
        data = test_product.serialize()
        data["category"] = "Invalid"  # wrong category
        product = Product()
        self.assertRaises(DataValidationError, product.deserialize, data)
